...
Problem #2
95% confidence interval of 45 employees is (142, 165)
```{r}
...
Problem #5
```{r}
salary_data <- read.csv('2013 ncaa tourney coaches salaries.csv')
...
Problem #6
```{r}
student_debt <- read_csv("student debt North Carolina.csv", col_type=list(.default=col_guess()))
print(student_debt)
...
Problem #7
```{r}
soda_cans <- read.csv('soda cans per week.csv')
...
Problem #8
Problem 8 is a question on P-Values.
